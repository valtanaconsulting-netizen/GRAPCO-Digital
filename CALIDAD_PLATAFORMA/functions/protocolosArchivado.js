...
// CALIDAD usa su propio proyecto Firebase: grapco-calidad-2026 (override con env STORAGE_BUCKET).
const STORAGE_BUCKET = process.env.STORAGE_BUCKET || 'grapco-calidad-2026.firebasestorage.app';
