    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          fontWeight: '800', letterSpacing: compact ? '1.6px' : '2px',
        }}>
          {APP_META.tagline}
        </p>
      </div>
      ...
      {/* Qué ofrece esta plataforma (visible también en móvil, donde no hay panel hero) */}
      {!isWide && (
        <p style={{ fontSize: '11.5px', color: 'rgba(255,255,255,0.78)', margin: '0 0 12px', fontWeight: 600, lineHeight: 1.5 }}>
          {APP_META.cardDesc}
        </p>
      )}
        ...
        <div style={{
          ...
          <div style={{ maxWidth: '560px', marginTop: 'auto', marginBottom: 'auto' }}>
            ...
            <h2 style={{
              ...
              {APP_META.titulo}<br /><span style={{ color: BASE.gold }}>{APP_META.tituloAccent}</span>
            </h2>
            <p style={{
              fontSize: '14.5px', color: 'rgba(255,255,255,0.82)', lineHeight: 1.65,
              marginBottom: '26px', maxWidth: '470px',
            }}>
              {APP_META.descripcion}
            </p>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              {APP_META.bullets.map((t) => (
