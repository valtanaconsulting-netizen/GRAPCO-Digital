...
// la Cloud Function de archivado a Drive). Todas las plataformas del ecosistema
// usan LAS MISMAS CUENTAS y la misma data; Calidad es la UI especializada en
// control de calidad. Las VITE_FIREBASE_* (de .env.production) las sobreescriben.
